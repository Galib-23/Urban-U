  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <div className="flex justify-between items-center mt-5">
        <span className="text-red-700 cursor-pointer hover:underline font-semibold hover:text-purple-500">Delete Account</span>
        <span className="text-red-700 cursor-pointer font-semibold hover:underline hover:text-purple-500">Sign Out</span>
      </div>
    </div>
  )
}
